...
public class HashFunction {
		...
		public String[] last20() throws IOException {
			...
			try {
			  ...
			  int iterate = 0;
			  List<Entry<String, Integer>>  top20Sublist = 
					  listOfEntry.subList(listOfEntry.size()-20, listOfEntry.size());
			  
			   //Create a loop for the top 20 values
			   for(Entry aList : top20Sublist) {
			   ...
			   return (String[])top20Sublist.toArray();
